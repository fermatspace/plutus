...
parseTerm :: (AsParserError e, MonadError e m) => ByteString -> m PTerm
...
-- of handling any parse errors.
parseProgram :: (AsParserError e, MonadError e m) => ByteString -> m (UPLC.Program PLC.Name PLC.DefaultUni PLC.DefaultFun SourcePos)
