...
import PlutusCore.Error (AsParserError, ParserError (..))
...
parseProgram :: (AsParserError e, MonadQuote m, MonadError e m) =>
...
-- of handling any parse errors.
parseTerm :: (AsParserError e, MonadQuote m, MonadError e m) =>
...
-- of handling any parse errors.
parseType :: (AsParserError e, MonadQuote m, MonadError e m) =>
